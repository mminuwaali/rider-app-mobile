...
import { slides } from "@/src/constants/data";
...
export default function () {
    ...
    return (
        <Animated.View className="flex-1 gap-4 bg-white">
            <TouchableOpacity onPress={handleSkip} className='absolute top-12 right-6 z-10'>
            ...
            <View className="px-10% pb-10">
                <TouchableOpacity onPress={handleNext} className='bg-cyan-600 py-4 rounded-lg items-center'>
